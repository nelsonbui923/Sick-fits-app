...
var RequestReset_ReqestReset =
/*#__PURE__*/
function (_Component) {
  RequestReset_inherits(ReqestReset, _Component);

  function ReqestReset() {
    var _getPrototypeOf2;

    var _this;

    RequestReset_classCallCheck(this, ReqestReset);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = RequestReset_possibleConstructorReturn(this, (_getPrototypeOf2 = RequestReset_getPrototypeOf(ReqestReset)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  RequestReset_createClass(ReqestReset, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      ...
      return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
        ...
        return external_react_default.a.createElement(Form["a" /* default */], {
          ...
          disabled: loading,
          "aria-busy": loading
        }, external_react_default.a.createElement("h2", null, "Change your password"), external_react_default.a.createElement(ErrorMessage["a" /* default */], {
          error: error
        }), !error && !loading && called && external_react_default.a.createElement("p", null, "Success! Chceck your email for link."), external_react_default.a.createElement("label", {
          htmlFor: "email"
        }, "Email", external_react_default.a.createElement("input", {
          type: "email",
          name: "email",
...
var signup_Signup = function Signup(props) {
  return external_react_default.a.createElement(Columns, null, external_react_default.a.createElement(SignUp_SignUp, null), external_react_default.a.createElement(SignIn["a" /* default */], null), external_react_default.a.createElement(RequestReset_ReqestReset, null));
};
