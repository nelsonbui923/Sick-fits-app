          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 6;
                return fetch('https://api.cloudinary.com/v1_1/nbui923/image/upload', {
                  method: 'Post',
                  body: data
                });
...
var sell_Sell = function Sell(props) {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(PleaseSignIn["a" /* default */], null, external_react_default.a.createElement(CreateItem_CreateItem, null)));
};
